...
if webCam.isOpened():
    ...
    cv2.imwrite("imagens/Semana2/Exercicio1/webCam_Original.png", frame)

    # Criar arquivo com a imagem em escala de cinza:
    cv2.imwrite("imagens/Semana2/Exercicio1/webCam_Gray.png", cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY))

    # Criar arquivo com a imagem azul:
    cv2.imwrite("imagens/Semana2/Exercicio1/webCam_Blue.png", cv2.merge([blue, zeros, zeros]))

    # Criar arquivo com a imagem verde:
    cv2.imwrite("imagens/Semana2/Exercicio1/webCam_Green.png", cv2.merge([zeros, green, zeros]))

    # Criar arquivo com a imagem vermelha:
    cv2.imwrite("imagens/Semana2/Exercicio1/webCam_Red.png", cv2.merge([zeros, zeros, red]))
