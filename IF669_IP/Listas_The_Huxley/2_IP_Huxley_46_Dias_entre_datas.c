...
int main()
{
    ...
    if(anoi != anof){ //ano inical e final diferentes
        ...
        mespro = mesi;
        while(mespro <= 12){
            if(mespro == mesi){//verifica��o do m�s inicial, precisa descontar a quantidade de dias corridos
                if(mesi <= 7 && mesi%2 == 1) quantDias+=31 - (diai - 1);
                //verficande de janeiro a julho
                else if (mesi <= 7 && mesi%2 == 0 && mesi != 2) quantDias+=30 - (diai - 1);
                else if(mesi == 2){
                if(anoi%400 == 0) quantDias = quantDias + 29 - (diai - 1);//C espress�o normal
            ...
            } else{ //verfica��o de m�s diferente do m�s inical
                //verficande de janeiro a julho
                if(mespro <= 7 && mespro%2 == 1) quantDias+=31;// C reduzido 
                else if (mespro <= 7 && mespro%2 == 0 && mespro != 2) quantDias+=30;
                else if(mespro == 2){
                    if(anoi%400 == 0) quantDias = quantDias + 29;// Espress�o normal
    ...
    //Calculo ano final
        ...
        while (mespro >= 1)
        {
            if(mespro == mesf){//verifica��o do m�s final, s� conta a quantidade de dias corridos
                quantDias+= diaf;

            } else{ //verfica��o de m�s diferente do m�s final 
